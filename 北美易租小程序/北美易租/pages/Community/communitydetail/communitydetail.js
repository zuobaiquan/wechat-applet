    ...
    wx.getStorage({
      ...
      success: function (res) {
        if (e.target.dataset.state) {
          apiRequest.postByToken('api/community/follow', {communityId:communityId,followFlag:1},_that.data.userToken)
            .then(function (res) {
              _that.setData({
                attendText: "+ 关注",
                isAttend: false,
          ...
          apiRequest.postByToken('api/community/follow', {communityId:communityId,followFlag:0},_that.data.userToken)
            .then(function (res) {
              _that.setData({
                attendText: "取消关注",
                isAttend: true,
