...
<script>
import { getOrderList,getAreaList,addGardenItem,deleteGardenItem,editGardenItem } from '@/api/vegetable'
export default {
  data() {
    return {
      list: null,
  ...
  methods: {
    fetchData() {
      ...
      getOrderList({'page':this.currentPage-1,'size':5},this.searchObj).then(response => {
