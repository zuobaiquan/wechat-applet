...
function patchUploadImage(tempFilePaths,success){
    ...
    function upload(){
        ...
        wx.uploadFile({
            url: 'https://asyc.oss-cn-shenzhen.aliyuncs.com',
            ...
            success: function(res){
                ...
                allFileUrl.push('https://asyc.oss-cn-shenzhen.aliyuncs.com/' + aliyunFileKey);
                count++;
...
//网络请求封装
const host = 'https://120.24.183.106:8443';
function baseRequest(path, parameter, method, success,dataType, fail) {
    var url = host + path;
    var data = parameter || {};
    var token = wx.getStorageSync('token') || 'Th5DiBrMtewI51J9EBITQzGyaLfICGpgj35XfGRGN33DfQVblHe9wtEzO7uvkbPl';
